<!--
Страница ошибки доступа (данный модуль не доступен определенной группе пользователя)
-->
<!doctype html>
<html lang="ru">
<head>
    ...
    <div class="justify-content-center error-content-center">
        <div class="row">
            <div class="col-lg-6 text-center">
                <h4 class="text-error font-weight-bold" >403</h4>
                <p class="text-muted">
                    У вас нет доступа к данной странице. Нет необходимых прав для ее просмотра.
                </p>
            ...
            <div class="col-lg-6 text-center">
                <img src="/images/403.svg" class="img-fluid">
            </div>
        </div>
    </div>
</div>
