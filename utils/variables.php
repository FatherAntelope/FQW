 ...
 * @var $email_support string контактный адрес e-почты поддержки приложения
 * @var $email_info string контактный адрес e-почты отправки важной информации приложения
...
const email_support = "support@saturn-mis.ru";
const email_info = "info@saturn-mis.ru";
const contact_number = "+7 (800) 800-80-80";
const contact_address = "Республика Башкортостан, г. Уфа";
?>
