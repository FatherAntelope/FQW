            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card">
                    <div class="card-header text-center" style="background-color: var(--cyan-color">
                        ...
                        <p class="mb-2 text-white" >"Роль"</p>
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="custom-switch custom-control mt-2">
                                            <input class="custom-control-input" id="idget_tasks" type="checkbox" checked>
                                            <label class="custom-control-label text-muted" for="idget_tasks">Задачи текущего дня</label>
                                        </div>
                                        <div class="custom-switch custom-control mt-2">
