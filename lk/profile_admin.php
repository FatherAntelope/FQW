                    ...
                    <div class="col-xl-12">
                        <div class="card mt-3">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted mt-0">График мониторинга пациентов</h5>
                                <canvas id="chart_patients" height="163"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <h5 class="text-muted mt-0">График мониторинга услуг</h5>
