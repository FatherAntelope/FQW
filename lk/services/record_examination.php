    ...
    <div class="container pt-3 pb-3">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h3 class="text-center font-weight-bold" style="color: var(--cyan-color)">Электрокардиография (ЭКГ)</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <h3>
                            ...
                            <span class="badge badge-info float-md-right mr-2">220 каб.</span>
                        </h3>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-lg-5">
                        <img src="https://www.ksmed.ru/images/kardiologiya/ekg2.jpg" class="img-fluid  rounded" alt="...">
                    </div>
                    <div class="col-lg-7">
